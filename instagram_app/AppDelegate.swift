...
//  instagram_app
//
//  Created by Nicholas Rosas on 2/19/18.
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        Parse.initialize(
            with: ParseClientConfiguration(block: { (configuration: ParseMutableClientConfiguration) -> Void in
                configuration.applicationId = "codepath_instagram_app"
                configuration.clientKey = "wefjoieruhfrehuoiswue"  // set to nil assuming you have not set clientKey
                configuration.server = "https://intense-tundra-37953.herokuapp.com/parse"
            })
        )
